                ...
                <div className="flex h-screen bg-green-300">
                    <div className="flex-1 flex flex-col overflow-hidden">
                        <header className="flex justify-between items-center bg-gray-300 p-5 shadow-2xl">
                            <a href="#">
                                <h2 className="text-2xl font-extrabold text-red-600 ml-10">Logo</h2>
                            </a>
                            ...
                            <div className="p-2 w-64">
                                <div className="bg-white flex items-center rounded-full shadow-xl h-18">
                                    ...
                                    <div className="p-2">
                                        <button className="bg-blue-500 text-white rounded-full p-2 hover:bg-blue-400 focus:outline-none w-12 h-12 flex items-center justify-center" type="submit">
                                            icon
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className="flex h-full ">
                            <nav className="flex w-96 h-full bg-gray-100 overflow-y-auto pb-10">
                                <div className="w-full flex mx-auto px-6 py-8">
                                    ...
                                    <ul className="space-y-2 text-2xl mr-10">
                                        <span>Tong quan</span>
                                        <li>
                                            <a href="#" className="flex items-center w-80 space-x-3 text-gray-700 p-2  font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
                            ...
                            <main className="flex flex-col w-full bg-white overflow-x-hidden overflow-y-auto mb-14">
                                <h2 className="flex py-4 px-4 sticky top-0 border-b bg-white items-center justify-between">
                                    <h1 className="font-bold tracking-wide text-4xl my-5 ml-5 ">Noi dung 1</h1>
                                ...
                                <div className="flex w-full mx-auto px-6 py-8">
                                    <div className="flex flex-col w-full h-full text-gray-900 text-xl border-4 border-gray-900 border-dashed">
                                        <div className="flex w-full max-w-xl h-60 items-center justify-center mx-auto bg-gray-100 border-b border-gray-600">
                                            <h2>
                                                <a className="px-5" href="#cau1">abc</a>
                                                <span>post</span>
                                            </h2>
                                        </div>
                                        <div className="flex w-full max-w-xl h-60 items-center justify-center mx-auto bg-gray-100 border-b border-gray-600">Post</div>
                                        <div className="flex w-full max-w-xl h-60 items-center justify-center mx-auto bg-gray-100 border-b border-gray-600">Post</div>
                                        <div className="flex w-full max-w-xl h-60 items-center justify-center mx-auto bg-gray-100 border-b border-gray-600">Post</div>
                                        <div className="flex w-full max-w-xl h-60 items-center justify-center mx-auto bg-gray-100 border-b border-gray-600">Post</div>
                            ...
                            <nav className="flex w-96 h-full bg-white">
                                <div className="w-full flex mx-auto px-6 py-8">
